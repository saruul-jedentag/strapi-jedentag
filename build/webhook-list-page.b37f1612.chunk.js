"use strict";(self.webpackChunkbackend_jedentag=self.webpackChunkbackend_jedentag||[]).push([[4121],{10395:(I,u,t)=>{t.r(u),t.d(u,{default:()=>me});var e=t(67294),s=t(57993),c=t(86706),m=t(36364),g=t(14087),T=t(17034),D=t(185),S=t(53979),j=t(36989),l=t(75515),C=t(29728),k=t(49066),U=t(41580),_=t(38939),ee=t(49386),te=t(8060),K=t(79031),i=t(37909),V=t(92155),ne=t(63237),ae=t(15234),P=t(11047),E=t(85893),F=t(88972);const $=F.ZP.div`
...
`,S=(0,s.ZP)(c.x)`
  ...
  width: 100%;
  border: none;
`,j=({children:l,icon:C,...k})=>(0,e.jsxs)("div",{children:[(0,e.jsx)(m.i,{}),(0,e.jsx)(S,{as:"button",background:"primary100",padding:5,...k,children:(0,e.jsxs)(g.k,{children:[(0,e.jsx)(D,{"aria-hidden":!0,background:"primary200",children:C}),(0,e.jsx)(c.x,{paddingLeft:3,children:(0,e.jsx)(T.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:l})})]})})]})}}]);
