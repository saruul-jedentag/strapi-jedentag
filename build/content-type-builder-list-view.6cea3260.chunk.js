"use strict";(self.webpackChunkbackend_jedentag=self.webpackChunkbackend_jedentag||[]).push([[5905],{3500:(oe,O,n)=>{n.r(O),n.d(O,{default:()=>rt});var e=n(67294),C=n(53979),m=n(11047),k=n(29728),H=n(49066),g=n(41580),l=n(57993),M=n(96315),S=n(85018),D=n(4585),X=n(67109),K=n(27361),r=n.n(K),f=n(18721),T=n.n(f),b=n(18446),x=n.n(b),P=n(11700),N=n.n(P),I=n(86896),J=n(16550),G=n(38939),ge=n(8060),fe=n(79031),_=n(37909),Z=n(75515),je=n(49386),ke=n(45697),o=n.n(ke),V=n(27523),he=n(47558),v=n(90635),$=n(88972);const ye=$.ZP.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
...
`,M=(0,C.ZP)(m.x)`
  ...
  width: 100%;
  border: none;
`,S=({children:D,icon:X,...K})=>(0,e.jsxs)("div",{children:[(0,e.jsx)(k.i,{}),(0,e.jsx)(M,{as:"button",background:"primary100",padding:5,...K,children:(0,e.jsxs)(H.k,{children:[(0,e.jsx)(l,{"aria-hidden":!0,background:"primary200",children:X}),(0,e.jsx)(m.x,{paddingLeft:3,children:(0,e.jsx)(g.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:D})})]})})]})}}]);
